        ...
        if (widget.class === "QLabel") {
            ...
            if ((parts.length === 5 || parts.length === 6) && parts[0] === "kvrel") {
                ...
                if (currentEditConfig.fields.find(field => field.id === attrname.split("__")[1])?.filterExpression) {
                    filterExpr = parseExpression(urrentEditConfig.fields.find(field => field.id === attrname.split("__")[1]).filterExpression, feature, this.props.iface, this.props.mapPrefix, this.props.mapCrs, () => this.setState({reevaluate: +new Date}), true);
                }
                return (
                    <EditComboField
